  ...
  return (
    ...
    >
      <div className={`p-3 rounded-[16px] transition-all duration-200 cursor-pointer ${
        isActive 
          ? 'bg-white/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] border border-white/10' 
        ...
        <div className="flex justify-between items-center mb-1">
          ...
          {Number(session.unreadCount) > 0 && (
            <span className="bg-[var(--color-primary)] text-white text-[11px] font-bold px-2 py-0.5 rounded-full shrink-0 shadow-[0_2px_4px_rgba(0,0,0,0.2)]">
              {session.unreadCount}
            </span>
          )}
        </div>
