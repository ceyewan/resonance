...
const file_gateway_v1_session_proto_rawDesc = "" +
	"\n" +
	"\x18gateway/v1/session.proto\x12\x14resonance.gateway.v1\x1a\x15common/v1/event.proto\x1a\x17common/v1/session.proto\x1a\x14common/v1/view.proto\"\x17\n" +
	...
	"\n" +
	"SearchUser\x12'.resonance.gateway.v1.SearchUserRequest\x1a(.resonance.gateway.v1.SearchUserResponse\x12w\n" +
	"\x12UpdateReadPosition\x12/.resonance.gateway.v1.UpdateReadPositionRequest\x1a0.resonance.gateway.v1.UpdateReadPositionResponse\x12k\n" +
	"\x0ePullInboxDelta\x12+.resonance.gateway.v1.PullInboxDeltaRequest\x1a,.resonance.gateway.v1.PullInboxDeltaResponseB\xd8\x01\n" +
	"\x18com.resonance.gateway.v1B\fSessionProtoP\x01Z<github.com/ceyewan/resonance/api/gen/go/gateway/v1;gatewayv1\xa2\x02\x03RGX\xaa\x02\x14Resonance.Gateway.V1\xca\x02\x14Resonance\\Gateway\\V1\xe2\x02 Resonance\\Gateway\\V1\\GPBMetadata\xea\x02\x16Resonance::Gateway::V1b\x06proto3"

var (
	file_gateway_v1_session_proto_rawDescOnce sync.Once
	file_gateway_v1_session_proto_rawDescData []byte
)

func file_gateway_v1_session_proto_rawDescGZIP() []byte {
	file_gateway_v1_session_proto_rawDescOnce.Do(func() {
		file_gateway_v1_session_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gateway_v1_session_proto_rawDesc), len(file_gateway_v1_session_proto_rawDesc)))
	})
