...
const file_logic_v1_session_proto_rawDesc = "" +
	"\n" +
	"\x16logic/v1/session.proto\x12\x12resonance.logic.v1\x1a\x15common/v1/event.proto\x1a\x17common/v1/session.proto\x1a\x14common/v1/view.proto\"\x17\n" +
	"\x15GetSessionListRequest\"V\n" +
	"\x16GetSessionListResponse\x12<\n" +
	"\bsessions\x18\x01 \x03(\v2 .resonance.common.v1.SessionInfoR\bsessions\"z\n" +
	"\x14CreateSessionRequest\x12\x18\n" +
	"\amembers\x18\x01 \x03(\tR\amembers\x12\x12\n" +
	...
	"\n" +
	"before_seq\x18\x03 \x01(\x03R\tbeforeSeq\"R\n" +
	"\x18GetHistoryEventsResponse\x126\n" +
	"\x06events\x18\x01 \x03(\v2\x1e.resonance.common.v1.ChatEventR\x06events\"\x17\n" +
	"\x15GetContactListRequest\"V\n" +
	"\x16GetContactListResponse\x12<\n" +
	"\bcontacts\x18\x01 \x03(\v2 .resonance.common.v1.ContactInfoR\bcontacts\")\n" +
	"\x11SearchUserRequest\x12\x14\n" +
	"\x05query\x18\x01 \x01(\tR\x05query\"L\n" +
	"\x12SearchUserResponse\x126\n" +
	"\x05users\x18\x01 \x03(\v2 .resonance.common.v1.ContactInfoR\x05users\"Q\n" +
	"\x19UpdateReadPositionRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\x12\x15\n" +
	"\x06seq_id\x18\x02 \x01(\x03R\x05seqId\"?\n" +
	"\x1aUpdateReadPositionResponse\x12!\n" +
	"\funread_count\x18\x01 \x01(\x03R\vunreadCount\"J\n" +
	"\x15PullInboxDeltaRequest\x12\x1b\n" +
	"\tcursor_id\x18\x01 \x01(\x03R\bcursorId\x12\x14\n" +
	"\x05limit\x18\x02 \x01(\x03R\x05limit\"\x92\x01\n" +
	...
	"\bhas_more\x18\x03 \x01(\bR\ahasMore2\xe7\x06\n" +
	"\x0eSessionService\x12g\n" +
	"\x0eGetSessionList\x12).resonance.logic.v1.GetSessionListRequest\x1a*.resonance.logic.v1.GetSessionListResponse\x12d\n" +
	"\rCreateSession\x12(.resonance.logic.v1.CreateSessionRequest\x1a).resonance.logic.v1.CreateSessionResponse\x12s\n" +
	"\x12CreateAgentSession\x12-.resonance.logic.v1.CreateAgentSessionRequest\x1a..resonance.logic.v1.CreateAgentSessionResponse\x12m\n" +
	"\x10GetHistoryEvents\x12+.resonance.logic.v1.GetHistoryEventsRequest\x1a,.resonance.logic.v1.GetHistoryEventsResponse\x12g\n" +
	"\x0eGetContactList\x12).resonance.logic.v1.GetContactListRequest\x1a*.resonance.logic.v1.GetContactListResponse\x12[\n" +
	"\n" +
	"SearchUser\x12%.resonance.logic.v1.SearchUserRequest\x1a&.resonance.logic.v1.SearchUserResponse\x12s\n" +
	"\x12UpdateReadPosition\x12-.resonance.logic.v1.UpdateReadPositionRequest\x1a..resonance.logic.v1.UpdateReadPositionResponse\x12g\n" +
	"\x0ePullInboxDelta\x12).resonance.logic.v1.PullInboxDeltaRequest\x1a*.resonance.logic.v1.PullInboxDeltaResponseB\xca\x01\n" +
	"\x16com.resonance.logic.v1B\fSessionProtoP\x01Z8github.com/ceyewan/resonance/api/gen/go/logic/v1;logicv1\xa2\x02\x03RLX\xaa\x02\x12Resonance.Logic.V1\xca\x02\x12Resonance\\Logic\\V1\xe2\x02\x1eResonance\\Logic\\V1\\GPBMetadata\xea\x02\x14Resonance::Logic::V1b\x06proto3"

var (
	file_logic_v1_session_proto_rawDescOnce sync.Once
	file_logic_v1_session_proto_rawDescData []byte
)

func file_logic_v1_session_proto_rawDescGZIP() []byte {
	file_logic_v1_session_proto_rawDescOnce.Do(func() {
		file_logic_v1_session_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_logic_v1_session_proto_rawDesc), len(file_logic_v1_session_proto_rawDesc)))
	})
	return file_logic_v1_session_proto_rawDescData
}

var file_logic_v1_session_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_logic_v1_session_proto_goTypes = []any{
	...
	(*CreateAgentSessionRequest)(nil),  // 4: resonance.logic.v1.CreateAgentSessionRequest
	(*CreateAgentSessionResponse)(nil), // 5: resonance.logic.v1.CreateAgentSessionResponse
	(*GetHistoryEventsRequest)(nil),    // 6: resonance.logic.v1.GetHistoryEventsRequest
	(*GetHistoryEventsResponse)(nil),   // 7: resonance.logic.v1.GetHistoryEventsResponse
	(*GetContactListRequest)(nil),      // 8: resonance.logic.v1.GetContactListRequest
	...
	(*PullInboxDeltaResponse)(nil),     // 15: resonance.logic.v1.PullInboxDeltaResponse
...
var file_logic_v1_session_proto_depIdxs = []int32{
	16, // 0: resonance.logic.v1.GetSessionListResponse.sessions:type_name -> resonance.common.v1.SessionInfo
	17, // 1: resonance.logic.v1.CreateSessionRequest.type:type_name -> resonance.common.v1.SessionType
	18, // 2: resonance.logic.v1.CreateAgentSessionRequest.profile:type_name -> resonance.common.v1.AgentProfile
	19, // 3: resonance.logic.v1.GetHistoryEventsResponse.events:type_name -> resonance.common.v1.ChatEvent
	20, // 4: resonance.logic.v1.GetContactListResponse.contacts:type_name -> resonance.common.v1.ContactInfo
	20, // 5: resonance.logic.v1.SearchUserResponse.users:type_name -> resonance.common.v1.ContactInfo
	21, // 6: resonance.logic.v1.PullInboxDeltaResponse.events:type_name -> resonance.common.v1.InboxEvent
	0,  // 7: resonance.logic.v1.SessionService.GetSessionList:input_type -> resonance.logic.v1.GetSessionListRequest
	2,  // 8: resonance.logic.v1.SessionService.CreateSession:input_type -> resonance.logic.v1.CreateSessionRequest
	4,  // 9: resonance.logic.v1.SessionService.CreateAgentSession:input_type -> resonance.logic.v1.CreateAgentSessionRequest
	6,  // 10: resonance.logic.v1.SessionService.GetHistoryEvents:input_type -> resonance.logic.v1.GetHistoryEventsRequest
	8,  // 11: resonance.logic.v1.SessionService.GetContactList:input_type -> resonance.logic.v1.GetContactListRequest
	10, // 12: resonance.logic.v1.SessionService.SearchUser:input_type -> resonance.logic.v1.SearchUserRequest
	12, // 13: resonance.logic.v1.SessionService.UpdateReadPosition:input_type -> resonance.logic.v1.UpdateReadPositionRequest
	14, // 14: resonance.logic.v1.SessionService.PullInboxDelta:input_type -> resonance.logic.v1.PullInboxDeltaRequest
	1,  // 15: resonance.logic.v1.SessionService.GetSessionList:output_type -> resonance.logic.v1.GetSessionListResponse
	3,  // 16: resonance.logic.v1.SessionService.CreateSession:output_type -> resonance.logic.v1.CreateSessionResponse
	5,  // 17: resonance.logic.v1.SessionService.CreateAgentSession:output_type -> resonance.logic.v1.CreateAgentSessionResponse
	7,  // 18: resonance.logic.v1.SessionService.GetHistoryEvents:output_type -> resonance.logic.v1.GetHistoryEventsResponse
	...
	15, // 22: resonance.logic.v1.SessionService.PullInboxDelta:output_type -> resonance.logic.v1.PullInboxDeltaResponse
...
func file_logic_v1_session_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_logic_v1_session_proto_rawDesc), len(file_logic_v1_session_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   16,
			NumExtensions: 0,
			NumServices:   1,
