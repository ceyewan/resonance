...
type Session struct {
	...
	Type          int    `gorm:"column:type;type:tinyint unsigned;not null"` // 1-单聊, 2-群聊
	Name          string `gorm:"column:name;type:varchar(128)"`
	OwnerUsername string `gorm:"column:owner_username;type:varchar(64)"`
	MaxSeqID      int64  `gorm:"column:max_seq_id;type:bigint unsigned;default:0"`
	CreatedAt     time.Time
	UpdatedAt     time.Time
}
...
type SessionMember struct {
	...
	LastReadSeq int64  `gorm:"column:last_read_seq;type:bigint unsigned;default:0"`
	CreatedAt   time.Time
	UpdatedAt   time.Time
}
...
type MessageContent struct {
	MsgID          int64  `gorm:"primaryKey;column:msg_id;type:bigint unsigned;autoIncrement:false"`
	...
	SeqID          int64  `gorm:"column:seq_id;type:bigint unsigned;not null;index:idx_sess_seq,priority:2"`
...
type Inbox struct {
	...
	MsgID         int64  `gorm:"column:msg_id;type:bigint unsigned;not null"`
	SeqID         int64  `gorm:"column:seq_id;type:bigint unsigned;not null;uniqueIndex:uniq_owner_sess_seq,priority:3"`
	IsRead        int    `gorm:"column:is_read;type:tinyint;default:0;index:idx_owner_read,priority:2"`
	CreatedAt     time.Time
}
